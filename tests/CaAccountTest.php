  ...
  3          $api->get('/{id}/pkcs12', $controller.'@certificateDownloadPKCS12');
   4         $api->get('/{id}/pem', $controller.'@certificateDownloadPEM'); /**/
    ...
    protected function validateCertificateRouteAccess($expected)
    {
        ...
        //
        echo PHP_EOL.__METHOD__.' User can view generate csr: '.$expected[$i];
        ...
        //
        echo PHP_EOL.__METHOD__.' User can view sign csr: '.$expected[$i];
        ...
        //
        echo PHP_EOL.__METHOD__.' User can view renew cert: '.$expected[$i];
