...
class Resign extends Command
{
     ...
     * @var string
     */
    protected $signature = 'acme:resign {--account_id=*} {--certificate_id=*} {--debug} {--force}';
     ...
     * @var string
     */
    protected $description = 'Resign certificates for an account expiring in the next 60 days';
    ...
    public function handle()
    {
        ...
        $this->handleAll();
        // scan selected certificates for resign
        $this->scanForRenew();
    }
    ...
    {
        // If they passed one or more account IDs queue those accounts to resign
