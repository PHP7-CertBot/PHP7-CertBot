...
<html>
	...
	<body>
		<div id="badbrowser">This is a javascript only webpage, your browser is not working properly. Use chrome or firefox with javascript enabled.</div>
		<div id="goodbrowser" style="display: none;">
			<div id="title">
